...
public class MetodosGenericos {
    ...
    public static String getDataNascimento(String mensagem){
        ...
        String data = ano + "-" + mes + "-" + dia; //Formata a data para inseri-la corretamente no Banco de Dados.
//      Este método funciona para coletar qualquer data corretamente sem travar o sistema, menos 29 de fevereiro.
        return data;
    }
